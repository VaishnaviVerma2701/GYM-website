...
mongoose.connect("mongodb://127.0.0.1:27017/gymfolder")
  .then(() => {
...
// Define the schema
const gmySchema = new mongoose.Schema({
  name: String,
  age: Number,
  gender: String,
  phone: Number,
...
// Create a model
const Gymproject = mongoose.model("Gymproject", gmySchema);
